...
class {ModelName} extends \MVCSystem\Generic\Model {
	/**
	 * Properties
	 */
	...
	private function __construct(){
		//throw new \Exception('Create Model-Instance corruption!<br/><br/>Use: <ul><li>::_oInstance() </li><li>::_oInstanceAdd() </li><li>::_oInstanceList() </li></ul>',-1);
	}
